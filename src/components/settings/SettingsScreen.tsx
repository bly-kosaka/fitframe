...
export function SettingsScreen() {
  ...
  return (
    <div className="grid min-h-0 flex-1 animate-screen-fade grid-cols-[1fr_392px] grid-rows-[1fr_auto] overflow-hidden">
      <div className="col-start-1 row-start-1 overflow-y-auto px-[34px] pb-6 pt-[30px]">
        <ScreenHeader
      ...
      <FooterBar className="col-span-full row-start-2">
